-- Feed sound session events.
--
-- Additive only, following the pattern of the earlier event migrations: every
-- previously accepted event name is retained, so existing dashboard metrics
